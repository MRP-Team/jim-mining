...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['ruby_ring'] = 1400,
		['sapphire_ring'] = 1500,
		['diamond_ring_silver'] = 700,
		['emerald_ring_silver'] = 800,
		['ruby_ring_silver'] = 900,
		['sapphire_ring_silver'] = 1000,

		['diamond_necklace'] = 2400,
		['emerald_necklace'] = 2500,
		['ruby_necklace'] = 2600,
		['sapphire_necklace'] = 2700,
		['diamond_necklace_silver'] = 900,
		['emerald_necklace_silver'] = 1000,
		['ruby_necklace_silver'] = 1100,
		['sapphire_necklace_silver'] = 1200,

		['diamond_earring'] = 1800,
		['emerald_earring'] = 1900,
		['ruby_earring'] = 2000,
		['sapphire_earring'] = 2100,
		['diamond_earring_silver'] = 800,
		['emerald_earring_silver'] = 900,
		['ruby_earring_silver'] = 1000,
		['sapphire_earring_silver'] = 1100,
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "weapon_flashlight", price = 1000, amount = 100, info = {}, type = "item", slot = 1, },
			-- { name = "goldpan", price = 1000, amount = 100, info = {}, type = "item", slot = 2, },
			{ name = "pickaxe",	price = 500, amount = 100, info = {}, type = "item", slot = 2, },
			{ name = "miningdrill",	price = 50000, amount = 50, info = {}, type = "item", slot = 3, },
			{ name = "mininglaser",	price = 150000, amount = 5, info = {}, type = "item", slot = 4, },
...
Crafting = {
	SmeltMenu = {
		...
		{ ["goldingot"] = { ["goldore"] = 5, ["carbon"] = 1 } },
		{ ["goldingot"] = { ["goldchain"] = 2 } },
		{ ["goldingot"] = { ["gold_ring"] = 6 } },
		{ ["silveringot"] = { ["silverore"] = 5, ["carbon"] = 1 } },
		{ ["silveringot"] = { ["silverchain"] = 2 } },
		{ ["silveringot"] = { ["silver_ring"] = 6 } },
		{ ["iron"] = { ["ironore"] = 1 }, ['amount'] = 4 },
		{ ["steel"] = { ["ironore"] = 1, ["carbon"] = 1 }, ['amount'] = 4 },
		{ ["aluminum"] = { ["can"] = 10, }, ['amount'] = 4 },
		{ ["glass"] = { ["bottle"] = 10, }, ['amount'] = 4 },
		{ ["plastic"] = { ["empty_plastic_bottle"] = 10, }, ['amount'] = 4 },
		{ ["rubber"] = { ["fishingboot"] = 100, } },
	},
	GemCut = {
	...
	RingCut = {
		{ ["gold_ring"] = { ["goldingot"] = 1 }, ['amount'] = 6 },
		{ ["silver_ring"] = { ["silveringot"] = 1 }, ['amount'] = 6 },
