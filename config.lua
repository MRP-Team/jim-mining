...
--Mining Store Items
	Items = {
		...
		items = {
			...
			{ name = "pickaxe",	price = 500, amount = 100, info = {}, type = "item", slot = 3, },
			{ name = "miningdrill",	price = 50000, amount = 50, info = {}, type = "item", slot = 4, },
			{ name = "mininglaser",	price = 150000, amount = 5, info = {}, type = "item", slot = 5, },
			{ name = "drillbit", price = 100, amount = 100, info = {}, type = "item", slot = 6, },
		},
	},
}
Crafting = {
